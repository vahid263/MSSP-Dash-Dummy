/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e23eebe9880ac79e1312047060073a23)
// Runtime types generated with workerd@1.20250730.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		NEXT_PUBLIC_SYNOPSIS_AUTH_EMAIL: string;
		NEXT_PUBLIC_SYNOPSIS_AUTH_KEY: string;
		NEXT_PUBLIC_SYNOPSIS_TENANT_UNIT_ID: string;
		ASSETS: Fetcher;
	}
}
